...
// Version bumped to 3.0.0 to match the app version in package.json and main.ts.
...
// ── Cursor pagination ────────────────────────────────────────────────────────
// Cursor encodes the `id` of the last item seen — stable across inserts/deletes.
...
// ── Smart paginate ───────────────────────────────────────────────────────────
// Accepts { page?, limit?, cursor? } — cursor mode wins if both are supplied.
export function smartPaginate(
  ...
  // No page, no cursor — cursor mode (first call of infinite scroll)
